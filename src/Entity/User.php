 ...
 * @UniqueEntity(
 *  fields={"email"},
 *  message="Un autre s'est déjà inscrit avec cette adresse email."
 * )
 */
class User implements UserInterface
{
     ...
     * @Assert\Length(min=100, minMessage="Votre description ne peux pas faire moins de 100 charactères !")
     */
    private $description;
